...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://web.archive.org/web/20240309215118/https://tetr.io/about/desktop/builds/9/TETR.IO%20Setup.deb";
    name = "tetrio-desktop.deb";
    sha256 = "1yqif1clf07dzdfxm125y4bvy314wkvary31vz9yy3vwq308pf2j";
  };
  ...
  installPhase = ''
    ...
    substituteInPlace $out/share/applications/TETR.IO.desktop \
      --replace "Exec=\"/opt/TETR.IO/TETR.IO\"" "Exec=\"$out/opt/TETR.IO/TETR.IO\""
